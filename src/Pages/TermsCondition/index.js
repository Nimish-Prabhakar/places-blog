  ...
  return (
    <>
      <div className="blogsPageHeader">
        <h3 className="latestBlogsTitle">Terms And Conditions</h3>
      </div>
      <div className="privacyWrapper">
        ...
        <p>
          ...
          Conditions, Privacy Statement and Disclaimer Notice and allAgreements:
          “Client”, “You” and “Your” refers to you, the person log on this
          website and compliant to the Company’sterms and conditions. “The
          Company”, “Ourselves”, “We”, “Our” and “Us”, refers to our Company.
          “Party”, “Parties”, or”Us”, refers to both the Client and ourselves.
          All terms refer to the offer, acceptance and consideration of
          paymentnecessary to undertake the process of our assistance to the
          Client in the most appropriate manner for the expresspurpose of
          meeting the Client’s needs in respect of provision of the Company’s
          stated services, in accordance with andsubject to, prevailing law of
        ...
        <h3 style={{ marginTop: '30px' }}>License</h3>
        <p>
        ...
        <p>
          ...
          website. weadsmob does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of weadsmob,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, weadsmob shall
          not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website. weadsmob
        ...
        <p>
          You hereby grant weadsmob a non-exclusive license to use, reproduce,
          edit and authorize others to use, reproduce and edit any of your
          Comments in any and all forms, formats or media.
        </p>
        <h3 style={{ marginTop: '30px' }}>Hyperlinking to our Content</h3>
        <p>
        ...
        <p>
          ...
          the hyperlink compensates the absence of weadsmob; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to weadsmob. Please include your name, your
        ...
        <p>
          No use of weadsmob’s logo or other artwork will be allowed for linking
          absent a trademark license agreement.
        </p>
        <h3 style={{ marginTop: '30px' }}>iFrames</h3>
        <p>
          Without prior approval and written permission, you may not create
          frames around our Webpages that alter in any way the visual
          presentation or appearance of our Website.
        </p>
        <h3 style={{ marginTop: '30px' }}>Content Liability</h3>
        <p>
        ...
        <h3 style={{ marginTop: '30px' }}>Your Privacy</h3>
        <p>Please read Privacy Policy</p>
        <h3 style={{ marginTop: '30px' }}>Reservation of Rights</h3>
        <p>
        ...
        <h3 style={{ marginTop: '30px' }}>Removal of links from our website</h3>
        <p>
