  ...
  return (
    <>
      <div className="blogsPageHeader">
        <h3 className="latestBlogsTitle">Privacy Policy</h3>
      </div>
      <div className="privacyWrapper">
        <h3 style={{ marginTop: '30px' }}>Privacy Notice</h3>
        ...
        <ul>
          ...
          <li>
            ervice Provider means any natural or legal person who processes the
        ...
        <p>
          ...
          section of our Privacy Policy.For more information about the cookies
